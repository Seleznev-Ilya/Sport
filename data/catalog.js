window.catalog = [{
    ...
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/all/suit/darkclassicfitsuit.png', 'img/all/suit/darkclassicfitsuit.png', 'img/all/suit/darkclassicfitsuit.png'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 19'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/page_1/OnlyBustedKneeJean.png', 'img/page_1/OnlyBustedKneeJean.png', 'img/page_1/OnlyBustedKneeJean.png'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: [],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/all/p7.png', 'img/all/p7.png', 'img/all/p7.png'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18'],
    thumbnail: 'thumbnail path', // replace with image extracted from item layout
    preview: ['img/all/p11.png', 'img/all/p11.png', 'img/all/p11.png'] // replace with paths to images extracted from item layout
}];
